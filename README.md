...
Módulo 1 (Da un Enter al final del archivo y pega esto)
...
1. **Database Queries:** Execute scripts in `sql/01_inventory_analysis.sql` and `sql/02_forecast_accuracy.sql` directly on your database environment.
2. **Python Scripts:** Run the data processing pipelines:
   ```bash
